...
//		result = restAPI.landingCall("18118895070", "语音文件名称", "文本内容", "来电显示的号码", "循环播放次数", "外呼通知状态通知回调地址", "第三方私有数据", "文本转语音后的发音速度", "文本转语音后的音量大小", "文本转语音后的音调", "文本转语音后的背景音编号", "是否同时播放文本和语音文件");
		result = restAPI.landingCall("18118895070", "", "文本内容", "来电显示的号码", "1", "", "", "", "", "", "", "");
